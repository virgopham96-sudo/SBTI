...
const personalityTypes = [
  ...
  { id: 'malo', code: 'MALO', name: 'Hệ Khỉ Khô', english: 'The Worker Monkey', desc: 'Bạn tự ví mình như chú khỉ nhỏ đang cố gắng xoay xở trong "rừng rậm" xã hội. Bạn chấp nhận số phận là một người lao động bền bỉ, bị bủa vây bởi deadline và những yêu cầu vô lý, nhưng bạn chọn cách đối mặt với chúng bằng những lời than vãn hài hước và một tâm thế "quậy ngầm". Bạn lanh lợi, thực tế và có khả năng sinh tồn cực cao. Thay vì gồng mình tỏ ra sang chảnh, bạn thoải mái với việc mình là một "chú khỉ" tinh quái, vừa làm vừa chơi và luôn có sẵn một rổ meme để tự giễu cợt chính mình.', quote: 'Cuộc đời là một chuyến đi săn quái vật và tôi chỉ là một chú khỉ nhỏ trong đó.', color: 'bg-red-50 text-red-700 border-red-200' },
